defmodule FoodTruckWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FoodTruckWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FoodTruckWeb.Gettext, "errors", msg, opts)
    end
  end
